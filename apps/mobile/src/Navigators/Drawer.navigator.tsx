...
import ListReactScreen from "../Entities/React/List.react.screen";
import ShowReactScreen from "../Entities/React/Show.react.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListReactScreen"
            component={ListReactScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowReactScreen"
          component={ShowReactScreen}
          options={screenOptions}
        />
